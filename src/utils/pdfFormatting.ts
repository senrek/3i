        ...
        stack: [
          // Dimension 1: Introvert vs Extrovert
          {
            columns: [
              { 
                width: '25%',
                text: `Introvert-[${dimensions[0].value}%]`,
                fontSize: 10,
                bold: true,
                margin: [0, 5, 0, 0]
              },
              ...
              { 
                width: '25%',
                text: `Extrovert-[${dimensions[1].value}%]`,
                fontSize: 10,
                bold: true,
                alignment: 'right',
                margin: [0, 5, 0, 0]
          ...
          // Dimension 2: Sensing vs iNtuitive
          {
            columns: [
              { 
                ...
                stack: [
                  {
                    text: `Sensing-[${dimensions[2].value}%]`,
                    fontSize: 10,
                    bold: true
                  },
                  {
              ...
              { 
                ...
                stack: [
                  {
                    text: `iNtuitive-[${dimensions[3].value}%]`,
                    fontSize: 10,
                    bold: true,
                    alignment: 'right'
                  },
          ...
          // Dimension 3: Thinking vs Feeling
          {
            columns: [
              { 
                width: '25%',
                text: `Thinking-[${dimensions[4].value}%]`,
                fontSize: 10,
                bold: true,
                margin: [0, 5, 0, 0]
              },
              ...
              { 
                width: '25%',
                text: `Feeling-[${dimensions[5].value}%]`,
                fontSize: 10,
                bold: true,
                alignment: 'right',
                margin: [0, 5, 0, 0]
          ...
          // Dimension 4: Judging vs Perceiving
          {
            columns: [
              { 
                ...
                stack: [
                  {
                    text: `Judging-[${dimensions[6].value}%]`,
                    fontSize: 10,
                    bold: true
                  },
                  {
              ...
              { 
                ...
                stack: [
                  {
                    text: `Perceiving-[${dimensions[7].value}%]`,
                    fontSize: 10,
                    bold: true,
                    alignment: 'right'
                  },
...
export const generateCareerReportContent = async (reportData: any, userName: string) => {
  try {
    ...
    if (reportData.scores && reportData.userName && supabase) {
      try {
      ...
      console.warn('Skipping AI content generation - missing required data or Supabase client');
    }
    ...
    const skillsAndAbilities = {
      overall: Math.round((aptitudeScore * 0.5 + personalityScore * 0.3 + interestScore * 0.2)),
      numerical: Math.round((aptitudeScore * 0.7 + personalityScore * 0.2 + interestScore * 0.1)),
      logical: Math.round((aptitudeScore * 0.8 + personalityScore * 0.1 + interestScore * 0.1)),
      verbal: Math.round((personalityScore * 0.6 + aptitudeScore * 0.3 + interestScore * 0.1)),
      clerical: Math.round((personalityScore * 0.4 + aptitudeScore * 0.4 + interestScore * 0.2)),
      spatial: Math.round((aptitudeScore * 0.6 + personalityScore * 0.2 + interestScore * 0.2)),
      leadership: Math.round((personalityScore * 0.5 + aptitudeScore * 0.3 + interestScore * 0.2)),
      social: Math.round((personalityScore * 0.7 + aptitudeScore * 0.1 + interestScore * 0.2)),
      mechanical: Math.round((aptitudeScore * 0.6 + personalityScore * 0.2 + interestScore * 0.2))
    };
