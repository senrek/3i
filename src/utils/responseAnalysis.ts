...
const analyzeAptitudeArea = (area: string, responses: Record<string, string>): number => {
  const areaQuestions: Record<string, string[]> = {
    ...
    social: ['apt_3', 'apt_6', 'apt_7', 'apt_28', 'apt_35', 'apt_36', 'apt_41', 'apt_58', 'apt_89'],
    leadership: ['apt_15', 'apt_16', 'apt_33', 'apt_39', 'apt_40', 'apt_43', 'apt_49'],
    business: ['apt_10', 'apt_24', 'apt_48', 'apt_56', 'apt_105']
  };
  ...
  return answeredCount > 0 ? Math.round((score / (answeredCount * 3)) * 100) : 50;
};
